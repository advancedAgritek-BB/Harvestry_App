    ...
    <section id="screenshots" className="relative py-24 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-8">
          <div className="inline-flex bg-surface/50 backdrop-blur-sm rounded-xl p-1.5 border border-border/50">
            {tabs.map((tab) => (
              <button
                key={tab.id}
        ...
        <div className="relative">
          {/* Glow Effect */}
          <div className="absolute -inset-8 bg-gradient-to-r from-accent-emerald/20 via-accent-cyan/20 to-accent-violet/20 blur-3xl opacity-40 rounded-3xl" />
          
          {/* Browser Window */}
          <div className="relative rounded-2xl overflow-hidden border border-border/50 shadow-2xl shadow-black/50 bg-background">
            {/* Browser Chrome */}
            <div className="h-10 bg-elevated/80 backdrop-blur flex items-center gap-2 px-4 border-b border-border/50">
...
function FeatureHighlight({ title, description }: FeatureHighlightProps) {
  return (
    <div className="text-center p-6 rounded-xl bg-surface/30 border border-border/50">
